...
#include<stdio.h>
int main() {
	int current_time,spend_time;
	scanf("%d %d",&current_time,&spend_time);
	int new_time = current_time/100*60+current_time%100+spend_time;
	int hour = new_time/60;
	int minute = new_time%60;
	printf("%d",hour);
	if(minute<10) {
		printf("0");
	}
